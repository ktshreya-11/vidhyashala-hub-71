...
const paths = [
  ...
  },
  {
    ...
    tag: "Real-time · Rooms · Chat",
    desc: "Create or join project rooms. Chat, share files, and edit code live with teammates across the world.",
  ...
  },
  {
    ...
    icon: Briefcase,
    title: "Industry Link",
    tag: "Tasks · Submissions · Leaderboard",
    desc: "Upload real-world tasks. Anyone can solve and submit — see who cracked what, with solved/unsolved status.",
    accent: "from-primary to-primary-glow",
  },
  {
